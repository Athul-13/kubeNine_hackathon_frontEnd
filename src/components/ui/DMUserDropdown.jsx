...
const DMUserDropdown = ({ selectedUser, onUserSelect, placeholder = "Search for a user..." }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      {/* Selected User */}
      {selectedUser && (
        <div className="flex items-center space-x-2 bg-blue-100 text-blue-800 px-3 py-2 rounded-lg mb-3">
          <User className="w-4 h-4" />
          <span className="flex-1">{selectedUser.name || selectedUser.username}</span>
          <button
